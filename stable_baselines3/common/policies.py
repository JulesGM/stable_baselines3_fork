...
from stable_baselines3.common.utils import get_device, is_vectorized_observation, obs_as_tensor, conv_bfloat16
...
class BaseModel(nn.Module, ABC):
    ...
    def parameters_to_vector(self) -> np.ndarray:
        ...
        :return:
        """
        return conv_bfloat16(th.nn.utils.parameters_to_vector(self.parameters()).detach().cpu()).numpy()
